...
public class ModeMenuBoardWidthNumber extends UIObject{
	...
	public ModeMenuBoardWidthNumber (int number) {
		this.number = number;
...
//		BufferedImage currentSprite = getCurrentSprite();
		...
		if (((ModeMenu) this.getParent().getParent()).getBoardWidth() == number || mouseSelected()) {
		...
		} else if (((ModeMenu) this.getParent().getParent()).getBoardWidth() != number) {
